...
\title{BedBihan - Rapport de conception}
...
\begin{document}
    ...
    \input{input/illustrations.tex}

    \input{input/diagrame_classes.tex}

    \input{input/etat_transition.tex}

    \input{input/interaction.tex}
